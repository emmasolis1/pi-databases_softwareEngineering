            ...
            <Table>
              ...
              <TableBody>
                ...
                >
                  ...
                  <TableCell>
                    ${parseFloat(report.netSalary0).toFixed(2)}
                  </TableCell>
                </TableRow>
                <TableRow
                  hover
                >
                  ...
                  <TableCell>
                    ${parseFloat(report.netSalary1).toFixed(2)}
                  </TableCell>
                </TableRow>
                <TableRow
                  hover
                >
                  ...
                  <TableCell>
                    ${parseFloat(report.netSalary3).toFixed(2)}
                  </TableCell>
                </TableRow>
              </TableBody>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>
                    ${parseFloat(parseFloat(report.netSalary0) + parseFloat(report.netSalary1) + parseFloat(report.netSalary3)).toFixed(2)}
                  </TableCell>
                </TableRow>
              </TableHead>
            </Table>
            ...
            <Table>
              ...
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>
                    ${mandatoryDeductionsTotal.toFixed(2)}
                  </TableCell>
                </TableRow>
              </TableHead>
            </Table>
